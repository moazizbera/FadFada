...
const AUDIO = "F:\\Projects\\Hackathons\\FadFada\\scripts\\demo-output\\dialogue3-audio";
const TH = "F:\\Projects\\Hackathons\\FadFada\\scripts\\demo-output\\talking-head3";
...
const TMP = path.join(OUT, "tmp-dialogue-v9");
const OUTPUT = path.join(OUT, "fadfada-dialogue-v9.mp4");
...
// Timing guide:
// 0:00-0:25 F_1-F_3 (text reasoning, persona prompting, chat/companions)      -> L1-7
// 0:25-0:50 F_4-F_7 (Daily Pulse context, saved moments, proof cards)         -> L8-9
// 0:50-1:35 F_8-F_12 (parent workspace, profiles, multimodal + JSON)          -> L10-16
// 1:35-2:20 F_13-F_19 (Ahmed child mode, role separation, game, stories)      -> L17-24
// 2:20-2:45 F_20, F_23-F_28 (oversight, return gate, new chat, daily, music)  -> L25-27
// 2:45-3:00 F_21_Admin-F_22_Admin (AI readiness, provider/model, ratings)     -> L28-30
const scenes = [
  { screen: "F_1",  line: 1 },  { screen: "F_1",  line: 2 },  { screen: "F_1",  line: 3 },
  { screen: "F_2",  line: 4 },  { screen: "F_2",  line: 5 },
  { screen: "F_3",  line: 6 },  { screen: "F_3",  line: 7 },
  { screen: "F_4",  line: 8 },  { screen: "F_7",  line: 9 },
  { screen: "F_8",  line: 10 }, { screen: "F_8",  line: 11 },
  { screen: "F_9",  line: 12 }, { screen: "F_10", line: 13 },
  { screen: "F_11", line: 14 }, { screen: "F_12", line: 15 },
  { screen: "F_12", line: 16 }, { screen: "F_14", line: 17 },
  { screen: "F_13", line: 18 }, { screen: "F_13", line: 19 },
  { screen: "F_24_Parent_Return_Gate", line: 20 },
  { screen: "F_25_Child_New_Chat", line: 21 },
  { screen: "F_26_Child_Daily_Moments", line: 22 },
  { screen: "F_15", line: 23 }, { screen: "F_18", line: 24 },
  { screen: "F_19", line: 25 }, { screen: "F_20", line: 26 },
  { screen: "F_28_Child_Music", line: 27 },
  { screen: "F_23_Children_Dropdown", line: 28 },
  { screen: "F_21_Admin", line: 29 }, { screen: "F_22_Admin", line: 30 },
];

const P_PARENT = { x: 45, y: 275, cx: 35, cy: 265 };
const P_CHILD  = { x: 1110, y: 275, cx: 1100, cy: 265 };

console.log("Step 1: Checking talking head videos...");
for (const sc of scenes) {
  ...
  if (!fs.existsSync(thPath) || fs.statSync(thPath).size < 10000) {
    console.error(`  MISSING talking head: ${thPath}`);
    process.exit(1);
  }
}
