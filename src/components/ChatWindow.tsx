...
const consultantScenarios: Record<Language, ConsultantScenario[]> = {
  ar: [
    ...
    },
    {
      ...
      text: "تصرف كخبير تسويق ومحتوى. اسألني عن المنتج والجمهور والمنصة إذا لم أوضحها، ثم أعطني زوايا محتوى، عرض بيع واضح، 5 أفكار منشورات، وخطة اختبار بسيطة.",
      world: "build",
  ...
  en: [
    ...
    },
    {
      ...
      text: "Act as a marketing and content strategist. Ask about the product, audience, and platform if I did not provide them, then give me content angles, a clear offer, 5 post ideas, and a simple testing plan.",
      world: "build",
      personaId: "maya_creator",
    },
    {
